...
#include "Mt2/Frugal_MtGen_330_Calculator.h"
...
int main(int argc, char * argv[]) {
  ...
  Mt2::Frugal_MtGen_330_Calculator mtGenCalculator(mt2_330_Calculator);
  ...
  // Now we print out the result:
    std::cout << "ANSWER: mtGenT = " << mtGenT << std::endl
	    ...
	    << " soln type was " << mtGenCalculator.lastSolutionType()
	    << std::endl; 
